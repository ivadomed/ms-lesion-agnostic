...
def plot_evaluation_results(results, output_folder):
    """
    ...
    for column in df.columns:
        if column in ['lesion_mapping_TP', 'lesion_mapping_FP', 'lesion_mapping_FN']:
            continue
...
if __name__ == "__main__":
    ...
    plot_evaluation_results(results, output_folder)
