...
parallel --jobs 3 ::: \
  ...
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S'); /home/p/plb/links/scratch/ms-lesion-agnostic/model_trainings/scripts/train_script_job4.sh 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/model_trainings/job3/logfile_job4_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S'); /home/p/plb/links/scratch/ms-lesion-agnostic/model_trainings/scripts/train_script_job5.sh 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/model_trainings/job3/logfile_job5_\$ts.txt)"