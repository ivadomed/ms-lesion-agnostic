...
PATH_JOB="/home/p/plb/links/projects/aip-jcohen/plb/results/job11"
...
output_folder="imagesTs_pred_chckFinal_fold0"

# First we preprocess the nnUNet_raw data
echo "Running inference on imagesTs with chck_final"

CUDA_VISIBLE_DEVICES=1 nnUNetv2_predict -i $PATH_INPUT_DATASET/$image_folder -o $PATH_JOB/$output_folder \
