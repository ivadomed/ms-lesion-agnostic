...
PATH_JOB="/home/p/plb/links/projects/aip-jcohen/plb/results/job14"
...
CUDA_VISIBLE_DEVICES=3 nnUNetv2_predict -i $PATH_INPUT_DATASET/$image_folder -o $PATH_JOB/$output_folder \
