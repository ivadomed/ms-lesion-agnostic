...
parallel --verbose --jobs 12 ::: \
  ...
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=0 nnUNetv2_train $dataset_number  $configurations 2 -p $plans_model1 -tr $trainer_job200 -pretrained_weights $pretrained_model1 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job200_fold2_\$ts.txt)" \
  ...
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=1 nnUNetv2_train $dataset_number  $configurations 4 -p $plans_model1 -tr $trainer_job200 -pretrained_weights $pretrained_model1 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job200_fold4_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=1 nnUNetv2_train $dataset_number  $configurations 0 -p $plans_model1 -tr $trainer_job210 -pretrained_weights $pretrained_model1 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job210_fold0_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=2 nnUNetv2_train $dataset_number  $configurations 1 -p $plans_model1 -tr $trainer_job210 -pretrained_weights $pretrained_model1 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job210_fold1_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=2 nnUNetv2_train $dataset_number  $configurations 2 -p $plans_model1 -tr $trainer_job210 -pretrained_weights $pretrained_model1 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job210_fold2_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=2 nnUNetv2_train $dataset_number  $configurations 3 -p $plans_model1 -tr $trainer_job210 -pretrained_weights $pretrained_model1 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job210_fold3_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=3 nnUNetv2_train $dataset_number  $configurations 4 -p $plans_model1 -tr $trainer_job210 -pretrained_weights $pretrained_model1 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job210_fold4_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=3 nnUNetv2_train $dataset_number  $configurations 0 -p $plans_model2 -tr $trainer_job220 -pretrained_weights $pretrained_model2 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job220_fold0_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=3 nnUNetv2_train $dataset_number  $configurations 1 -p $plans_model2 -tr $trainer_job220 -pretrained_weights $pretrained_model2 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job220_fold1_\$ts.txt)" \