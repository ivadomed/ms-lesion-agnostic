...
parallel --verbose --jobs 8 ::: \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=0 nnUNetv2_train $dataset_number  $configurations 1 -p $plans_model2 -tr $trainer_job230 --c 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job230_fold1_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=0 nnUNetv2_train $dataset_number  $configurations 2 -p $plans_model2 -tr $trainer_job230 --c 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job230_fold2_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=1 nnUNetv2_train $dataset_number  $configurations 3 -p $plans_model2 -tr $trainer_job230 --c 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job230_fold3_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=1 nnUNetv2_train $dataset_number  $configurations 4 -p $plans_model2 -tr $trainer_job230 --c 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job230_fold4_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=2 nnUNetv2_train $dataset_number  $configurations 0 -p $plans_model2 -tr $trainer_job240 --c 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job240_fold0_\$ts.txt)" \
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=2 nnUNetv2_train $dataset_number  $configurations 1 -p $plans_model2 -tr $trainer_job240 --c 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job240_fold1_\$ts.txt)" \
  ...
  "(ts=\$(date '+%Y-%m-%d-%H-%M-%S');  CUDA_VISIBLE_DEVICES=3 nnUNetv2_train $dataset_number  $configurations 3 -p $plans_model2 -tr $trainer_job240 --c 2>&1 | tee /home/p/plb/links/scratch/ms-lesion-agnostic/final_trainings/logfile_job240_fold3_\$ts.txt)" \