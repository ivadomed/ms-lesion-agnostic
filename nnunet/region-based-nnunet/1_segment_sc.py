...
# # Canproco dataset
# canproco_path = Path('/Users/plbenveniste/Documents/data/canproco')
# # Exclude liste
# exclude_list = Path('/Users/plbenveniste/Documents/canproco/exclude.yml')
# # Model path 
# model_path = Path('/Users/plbenveniste/Documents/model_ms_seg_sc-lesion_regionBased/nnUNetTrainer__nnUNetPlans__2d')
# # Output folder
# canproco_output_folder = Path('/Users/plbenveniste/Documents/canproco_sc_seg')
# # QC folder 
# canproco_qc_folder = Path('/Users/plbenveniste/Documents/canproco_sc_seg_qc')
...
#                 os.system(f'python /Users/plbenveniste/Documents/canproco/packaging/run_inference_single_subject.py --path-image {str(inv_file)} --path-out {str(output_dir)} --path-model {str(model_path)}')
