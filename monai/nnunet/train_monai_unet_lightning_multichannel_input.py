    ...
    def prepare_data(self):
        ...
        train_transforms = Compose(
            [
                ...
                ConcatItemsd(keys=["image", "sc"], name="inputs"),
                EnsureTyped(keys=["inputs", "label"]),
                # AsDiscreted(
                #     keys=["label"],
                #     num_classes=2,
...
def main():
    ...
    wandb.save("ms-lesion-agnostic/monai/nnunet/train_monai_unet_lightning_multichannel.py")
